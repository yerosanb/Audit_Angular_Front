...
import { AbnormalBalanceBranchManagerService } from '../service/abnormal-balance-branch-manager.service';


@Component({
  selector: 'app-abnormal-balance-pending-branch-manager',
  templateUrl: './abnormal-balance-pending-branch-manager.component.html',
  styles: [
    `
  ...
  styleUrls: ['./abnormal-balance-pending-branch-manager.component.css']
})
export class AbnormalBalancePendingBranchManagerComponent {
...
descripancyCategory: OperationalDescripancyCategory = new  OperationalDescripancyCategory()
  ...
  constructor(
    ...
    private abnormalBalanceBranchManagerService: AbnormalBalanceBranchManagerService,
  ...
  getFindings(branch_audit: any) {
    this.abnormalBalanceBranchManagerService.getPendingAudits(branch_audit).subscribe(
      (response) => {
