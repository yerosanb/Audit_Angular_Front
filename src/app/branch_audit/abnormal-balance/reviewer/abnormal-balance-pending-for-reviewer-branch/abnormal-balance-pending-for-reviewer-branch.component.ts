...
@Component({
  selector: 'app-abnormal-balance-pending-for-reviewer-branch',
  templateUrl: './abnormal-balance-pending-for-reviewer-branch.component.html',
  styles: [
    `
  ...
  styleUrls: ['./abnormal-balance-pending-for-reviewer-branch.component.css'],
})
export class AbnormalBalancePendingForReviewerBranchComponent {
  ...
  getFindings(user: any) {
    this.abnormalBalanceReviewerBranchService
      .getPendingAbnormalBalance(user)
      .subscribe(
        (response) => {
  ...
  reviewAbnormalBalance(audit: BranchFinancialAudit) {
    ...
    this.confirmationService.confirm({
      ...
      accept: () => {
        this.commonReviewerBranchService.reviewFindings(audit).subscribe({
          next: () => {
