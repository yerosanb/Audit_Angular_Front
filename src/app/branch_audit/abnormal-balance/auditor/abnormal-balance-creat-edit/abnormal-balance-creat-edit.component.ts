...
@Component({
  selector: 'app-abnormal-balance-creat-edit',
  templateUrl: './abnormal-balance-creat-edit.component.html',
  styleUrls: ['./abnormal-balance-creat-edit.component.css'],
})
export class AbnormalBalanceCreatEditComponent {
  ...
  saveAudit() {
    ...
    this.auditData.audit_type = 'Abnormal Balance';
    ...
    if (this.file_uploaded) {
      ...
      this.abnormalBalanAuditorService
        .createAbnormalBalance(this.auditData)
        .subscribe({
          next: () => {
