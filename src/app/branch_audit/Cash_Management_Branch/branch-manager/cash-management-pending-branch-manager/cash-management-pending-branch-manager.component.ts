...
import { CashManagementBranchManagerService } from '../service/cash-management-branch-manager.service';

  @Component({
    selector: 'app-cash-management-pending-branch-manager',
    templateUrl: './cash-management-pending-branch-manager.component.html',
    styles: [
      `
    ...
    styleUrls: ['./cash-management-pending-branch-manager.component.css']
  })
  export class CashManagementPendingBranchManagerComponent {
  ...
  descripancyCategory: OperationalDescripancyCategory = new  OperationalDescripancyCategory()
    ...
    constructor(
      ...
      private cashManagementBranchManagerService: CashManagementBranchManagerService,
    ...
    getFindings(branch_audit: any) {
      this.cashManagementBranchManagerService.getPendingAudits(branch_audit).subscribe(
        (response) => {
