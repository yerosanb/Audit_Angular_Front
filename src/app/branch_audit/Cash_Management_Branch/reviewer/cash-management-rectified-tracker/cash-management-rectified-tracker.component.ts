...
@Component({
  selector: 'app-cash-management-rectified-tracker',
  templateUrl: './cash-management-rectified-tracker.component.html',
  styleUrls: ['./cash-management-rectified-tracker.component.css']
})
export class CashManagementRectifiedTrackerComponent {
  ...
  ngOnInit(): void {
    ...
    this.audit_info.audit_type = 'CashManagement';
