...
@Component({
  selector: 'app-auditor-cash-management-pending',
  templateUrl: './auditor-cash-management-pending.component.html',
  styles: [
    `
  ...
  styleUrls: ['./auditor-cash-management-pending.component.css'],
})
export class AuditorCashManagementPendingComponent {
  ...
  getFindings(auditor_id: number) {
    this.auditorCashManagementBranchService.getDraftingCashManagementAudits(auditor_id).subscribe(
      (response) => {
          ...
          error: (error: HttpErrorResponse) => {
            ...
            this.messageService.add({
              ...
              summary:
                error.status == 401
                  ? 'You are not permitted to perform this action!'
                  : 'Something went wrong while passing cash management to the reviewer!',
              detail: '',
            });
          },
        });
        ...
        this.auditService.passSelectedAudits(this.selectedAudits).subscribe({
          next: (response) => {
            ...
            this.messageService.add({
              severity: 'success',
              summary: 'Successful',
              detail: 'Cash Management passed to reviewer',
              life: 3000,
            });
          },
          error: (error: HttpErrorResponse) => {
