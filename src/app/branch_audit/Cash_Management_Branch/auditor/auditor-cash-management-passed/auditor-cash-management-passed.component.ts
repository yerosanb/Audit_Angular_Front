...
@Component({
  selector: 'app-auditor-cash-management-passed',
  templateUrl: './auditor-cash-management-passed.component.html',
  styles: [
    `
  ...
  styleUrls: ['./auditor-cash-management-passed.component.css'],
})
export class AuditorCashManagementPassedComponent {
  ...
  ngOnInit() {
    ...
    this.cols = [
      ...
      { field: 'mid_rate_fcy', header: ' Mid_Rate_fcy' },
    ];
  ...
  DataChange(data: BranchFinancialAudit[]) {
    if (data) {
          ...
          .subscribe({
            next: (response) => {
              ...
              this.messageService.add({
                severity: 'success',
                summary: 'Successful',
                detail: 'Cash management rectified',
                life: 3000,
              });
            },
              ...
              this.messageService.add({
                ...
                summary:
                  error.status == 401
                    ...
                    : 'Something went wrong while rectifiying cash management!',
                detail: '',
              });
            },
          });
  ...
  getFindings(auditor_id: number) {
    this.auditorCashManagementBranchService
      .getPassedCashManagementAudits(auditor_id)
      .subscribe(
        (response) => {
        ...
        this.auditService.backAudit(audit.id).subscribe({
          next: (response) => {
            ...
            this.messageService.add({
              severity: 'success',
              summary: 'Successful',
              detail: 'Cash Management return to drafting status',
              life: 3000,
            });
          },
          error: (error: HttpErrorResponse) => {
            ...
            this.messageService.add({
              ...
              summary:
                error.status == 401
                  ? 'You are not permitted to perform this action!'
                  : 'Something went wrong while returning cash management to the drafting status!',
              detail: '',
            });
          },
        });
        ...
        this.auditService.backSelectedAudits(this.selectedAudits).subscribe({
          next: (response) => {
            ...
            this.messageService.add({
              severity: 'success',
              summary: 'Successful',
              detail: 'Cash Management Deleted',
              life: 3000,
            });
          },
          error: (error: HttpErrorResponse) => {
            ...
            this.messageService.add({
              ...
              summary:
                error.status == 401
                  ? 'You are not permitted to perform this action!'
                  : 'Something went wrong while deleting cash management!',
              detail: '',
            });
          },
        });
