...
@Component({
  selector: 'app-cash-count-reviewer-rectification-tracker',
  templateUrl: './cash-count-reviewer-rectification-tracker.component.html',
  styles: [
    `
  ...
  styleUrls: ['./cash-count-reviewer-rectification-tracker.component.css'],
})
export class CashCountReviewerRectificationTrackerComponent {
  ...
  ngOnInit(): void {
    ...
    this.audit_info.audit_type = 'CashCount';
