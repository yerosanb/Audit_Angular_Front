...
@Component({
  selector: 'app-negotiable-instrument-passed-branch',
  templateUrl: './negotiable-instrument-passed-branch.component.html',
  styles: [
    `
  ...
  styleUrls: ['./negotiable-instrument-passed-branch.component.css'],
})
export class NegotiableInstrumentPassedBranchComponent {
  ...
  getFindings(auditor_id: number) {
    this.negotiableInstrumentService
      .getPassedNegotiableInstrument(auditor_id)
      .subscribe(
        (response) => {
  ...
  backAudit(audit: BranchFinancialAudit) {
    this.confirmationService.confirm({
      ...
      accept: () => {
        this.negotiableInstrumentService
          .backPassedNegotiableInstrument(audit)
          .subscribe({
            next: (response) => {
  ...
  backSelectedAudits() {
    ...
    if (this.selectedAudits.length > 0) {
      this.confirmationService.confirm({
        ...
        accept: () => {
          this.negotiableInstrumentService
            .backSelectedPassedNegotiableInstrument(this.selectedAudits)
            .subscribe({
              next: (response) => {
