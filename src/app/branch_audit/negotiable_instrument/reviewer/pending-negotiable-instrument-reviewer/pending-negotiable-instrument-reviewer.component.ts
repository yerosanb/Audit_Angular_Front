...
@Component({
  selector: 'app-pending-negotiable-instrument-reviewer',
  templateUrl: './pending-negotiable-instrument-reviewer.component.html',
  styles: [
    `
  ...
  styleUrls: ['./pending-negotiable-instrument-reviewer.component.css'],
})
export class PendingNegotiableInstrumentReviewerComponent {
  ...
  getFindings(region_id: any) {
    this.negotiableInstrumentReviewerService
      .getPendingNegotiableInstrument(region_id)
      .subscribe(
        (response) => {
