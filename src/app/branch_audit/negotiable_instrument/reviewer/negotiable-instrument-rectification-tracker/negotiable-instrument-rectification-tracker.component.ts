...
@Component({
  selector: 'app-negotiable-instrument-rectification-tracker',
  templateUrl: './negotiable-instrument-rectification-tracker.component.html',
  styles: [
    `
  ...
  styleUrls: ['./negotiable-instrument-rectification-tracker.component.css'],
})
export class NegotiableInstrumentRectificationTrackerComponent {
  ...
  ngOnInit(): void {
    ...
    this.audit_info.audit_type = 'NegotiableInstrument';
    ...
    this.cols = [
      ...
      { field: 'category', header: 'Stock Item' },
      { field: 'ck_type', header: 'Cheque Type' },
      { field: 'ck_range', header: 'Cheque Range' },
