...
@Component({
  selector: 'app-reviewer-cash-performance-reviewed',
  templateUrl: './reviewer-cash-performance-reviewed.component.html',
  styleUrls: ['./reviewer-cash-performance-reviewed.component.css'],
})
export class ReviewerCashPerformanceReviewedComponent {
  ...
  ngOnInit(): void {
    ...
    this.cashPerformanceReviewerService.getReviewedAudits(user.id).subscribe(
      (response) => {
  ...
  compileAudits() {
    ...
    this.outputData.push('CashPerformance');
