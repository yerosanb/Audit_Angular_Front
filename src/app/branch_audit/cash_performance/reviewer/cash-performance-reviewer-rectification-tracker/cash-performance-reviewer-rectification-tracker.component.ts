...
@Component({
  selector: 'app-cash-performance-reviewer-rectification-tracker',
  templateUrl: './cash-performance-reviewer-rectification-tracker.component.html',
  styleUrls: ['./cash-performance-reviewer-rectification-tracker.component.css']
})
export class CashPerformanceReviewerRectificationTrackerComponent {
  ...
  ngOnInit(): void {
    ...
    this.audit_info.audit_type = 'CashPerformance';
