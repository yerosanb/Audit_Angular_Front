...
@Component({
  selector: 'app-create-edit-cash-performance-branch',
  templateUrl: './create-edit-cash-performance-branch.component.html',
  styleUrls: ['./create-edit-cash-performance-branch.component.css'],
})
export class CreateEditCashPerformanceBranchComponent {
  ...
  getCommonFindings() {
    this.commonFindingService
      .getFindingsByAuditType("CashPerformance")
      .subscribe(
        (response) => {
  ...
  getCommonRecommendations() {
    this.recommendationService
      .getRecommondationsByAuditType("CashPerformance")
      .subscribe(
        (response) => {
  ...
  editAudit(passedData: any[]) {
    ...
    this.cash_type_intial = this.auditData.cashPerformanceBranch?.cash_type;
  ...
  saveAudit() {
    ...
    if (this.file_uploaded) {
      this.loading=true;
      this.cashPerformanceAuditorService.create(this.auditData).subscribe({
        next: (response) => {
