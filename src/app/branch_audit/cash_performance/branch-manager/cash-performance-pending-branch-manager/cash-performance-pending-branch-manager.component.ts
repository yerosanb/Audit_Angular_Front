...
import { CashPerformanceBranchManagerService } from '../service/cash-performance-branch-manager.service';

  @Component({
    selector: 'app-cash-performance-pending-branch-manager',
    templateUrl: './cash-performance-pending-branch-manager.component.html',
    styles: [
      `
    ...
    styleUrls: ['./cash-performance-pending-branch-manager.component.css']
  })
  export class CashPerformancePendingBranchManagerComponent  {
  ...
  descripancyCategory: OperationalDescripancyCategory = new  OperationalDescripancyCategory()
    ...
    constructor(
      ...
      private cashPerformanceBranchManagerService: CashPerformanceBranchManagerService,
    ...
    getFindings(branch_audit: any) {
      this.cashPerformanceBranchManagerService.getPendingAudits(branch_audit).subscribe(
        (response) => {
