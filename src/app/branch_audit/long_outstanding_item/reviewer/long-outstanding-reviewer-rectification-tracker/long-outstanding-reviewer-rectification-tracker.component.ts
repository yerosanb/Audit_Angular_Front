...
@Component({
  selector: 'app-long-outstanding-reviewer-rectification-tracker',
  templateUrl: './long-outstanding-reviewer-rectification-tracker.component.html',
  styles: [
    `
  ...
  styleUrls: ['./long-outstanding-reviewer-rectification-tracker.component.css']
})
export class LongOutstandingReviewerRectificationTrackerComponent {
  ...
  ngOnInit(): void {
    ...
    this.audit_info.audit_type = 'LongOutstandingItems';
