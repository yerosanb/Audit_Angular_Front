...
import { SuspenseAccountBranchManagerService } from '../service/suspense-account-branch-manager.service';


  @Component({
    selector: 'app-suspense-account-pending-branch-manager',
    templateUrl: './suspense-account-pending-branch-manager.component.html',
    styles: [
      `
    ...
    styleUrls: ['./suspense-account-pending-branch-manager.component.css']
  })
  export class SuspenseAccountPendingBranchManagerComponent {
  ...
  descripancyCategory: OperationalDescripancyCategory = new  OperationalDescripancyCategory()
    ...
    constructor(
      ...
      private suspenseAccountBranchManagerService: SuspenseAccountBranchManagerService,
  ...
  private remarkService: RemarkBranchAuditService,
    ...
    getFindings(branch_audit: any) {
      this.suspenseAccountBranchManagerService.getPendingAudits(branch_audit).subscribe(
        (response) => {
