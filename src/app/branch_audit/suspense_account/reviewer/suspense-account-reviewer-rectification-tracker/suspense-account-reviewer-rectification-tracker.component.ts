...
@Component({
  selector: 'app-suspense-account-reviewer-rectification-tracker',
  templateUrl: './suspense-account-reviewer-rectification-tracker.component.html',
  styles: [
    `
  ...
  styleUrls: ['./suspense-account-reviewer-rectification-tracker.component.css']
})
export class SuspenseAccountReviewerRectificationTrackerComponent {
  ...
  ngOnInit(): void {
    ...
    this.audit_info.audit_type = 'SuspenseAccount';
