...
@Component({
  selector: 'app-suspense-account-passed-branch',
  templateUrl: './suspense-account-passed-branch.component.html',
  styles: [
    `
  ...
  styleUrls: ['./suspense-account-passed-branch.component.css']
})
export class SuspenseAccountPassedBranchComponent {
  ...
  ngOnInit() {
    ...
    this.cols = [
      ...
      { field: 'balance_per_trial_balance', header: 'Balance Per Trial Balance' },
  ...
  getFindings(auditor_id: number) {
    this.suspenseAccountBranchService.getPassedSuspenseAccount(auditor_id).subscribe(
      (response) => {
  ...
  backAudit(audit: BranchFinancialAudit) {
    this.confirmationService.confirm({
      ...
      accept: () => {
        this.suspenseAccountBranchService.backPassedSuspenseAccount(audit).subscribe({
          next: (response) => {
  ...
  backSelectedAudits() {
    ...
    this.confirmationService.confirm({
      ...
      icon: 'pi pi-exclamation-triangle',
      accept: () => {
        this.suspenseAccountBranchService.backSelectedPassedSuspenseAccount(this.selectedAudits).subscribe({
          next: (response) => {
