...
@Component({
  selector: 'app-suspense-account-create-edit',
  templateUrl: './suspense-account-create-edit.component.html',
  styleUrls: ['./suspense-account-create-edit.component.css'],
})
export class SuspenseAccountCreateEditComponent {
  ...
  getCommonFindings() {
    this.commonFindingService
      .getFindingsByAuditType('SuspenseAccount')
      .subscribe(
        (response) => {
  ...
  getCommonRecommendations() {
    this.recommendationService
      .getRecommondationsByAuditType('SuspenseAccount')
      .subscribe(
        (response) => {
  ...
  editAudit(passedData: any[]) {
    ...
    let findingDate: any;
    this.cash_type_intial = this.auditData.suspenseAccountBranch?.cash_type;
  ...
  saveAudit() {
    ...
    this.auditData.suspenseAccountBranch!.tracer_date = finding_date;
    ...
    this.auditData.audit_type = 'Suspense Account';
    ...
    if (this.file_uploaded) {
      ...
      this.suspenseAccountBranchService
        .createSuspenseAccount(this.auditData)
        .subscribe({
          next: () => {
  ...
  computeDifference() {
    if (this.auditData.suspenseAccountBranch) {
      if (
        ...
        this.auditData.suspenseAccountBranch!.difference =
          this.auditData.suspenseAccountBranch?.balance_per_tracer -
          this.auditData.suspenseAccountBranch?.balance_per_trial_balance;
      }
    }
