...
import { ControllableExpenseBranchManagerService } from '../service/controllable-expense-branch-manager.service';

  @Component({
    selector: 'app-controllable-expense-pending-branch-manager',
    templateUrl: './controllable-expense-pending-branch-manager.component.html',
    styles: [
      `
    ...
    styleUrls: ['./controllable-expense-pending-branch-manager.component.css']
  })
  export class ControllableExpensePendingBranchManagerComponent  {
  ...
  descripancyCategory: OperationalDescripancyCategory = new  OperationalDescripancyCategory()
    ...
    constructor(
      ...
      private controllableExpenseBranchManagerService: ControllableExpenseBranchManagerService,
  ...
  private remarkService: RemarkBranchAuditService,
    ...
    getFindings(branch_audit: any) {
      this.controllableExpenseBranchManagerService.getPendingAudits(branch_audit).subscribe(
        (response) => {
