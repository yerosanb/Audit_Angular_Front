...
@Component({
  selector: 'app-controllable-expense-passed',
  templateUrl: './controllable-expense-passed.component.html',
  styles: [
    `
  ...
  styleUrls: ['./controllable-expense-passed.component.css']
})
export class ControllableExpensePassedComponent {
  ...
  ngOnInit() {
    ...
    this.cols = [
      ...
      { field: 'controllable_expense_type', header: 'Controllable Expense Type' },
  ...
  getFindings(auditor_id: number) {
    this.controllableExpenseService.getPassedSuspenseAccount(auditor_id).subscribe(
      (response) => {
  ...
  backAudit(audit: BranchFinancialAudit) {
    this.confirmationService.confirm({
      ...
      accept: () => {
        this.controllableExpenseService.backPassedSuspenseAccount(audit).subscribe({
          next: (response) => {
  ...
  backSelectedAudits() {
    ...
    this.confirmationService.confirm({
      ...
      icon: 'pi pi-exclamation-triangle',
      accept: () => {
        this.controllableExpenseService.backSelectedPassedSuspenseAccount(this.selectedAudits).subscribe({
          next: (response) => {
