...
@Component({
  selector: 'app-controllable-exspense-create-edit',
  templateUrl: './controllable-exspense-create-edit.component.html',
  styleUrls: ['./controllable-exspense-create-edit.component.css'],
})
export class ControllableExspenseCreateEditComponent {
  ...
  suspenseAccountDataOptions: ControllableExpenseType[];
  ...
  ngOnInit() {
    ...
    this.getControllableExpenseType();
  }

  getCommonFindings() {
    this.commonFindingService
      .getFindingsByAuditType('ControllableExpense')
      .subscribe(
        (response) => {
  ...
  getCommonRecommendations() {
    this.recommendationService
      .getRecommondationsByAuditType('ControllableExpense')
      .subscribe(
        (response) => {
  ...
  editAudit(passedData: any[]) {
    ...
    this.cash_type_intial = this.auditData.controllableExpense?.cash_type;
  ...
  saveAudit() {
    ...
    this.auditData.controllableExpense!.period = finding_date;
    ...
    this.auditData.audit_type = 'Controllable Expense';
  ...
  computeDifference() {
    if (this.auditData.controllableExpense) {
      if (
        this.auditData.controllableExpense?.budget_per_plan &&
        this.auditData.controllableExpense?.actual_balance
      ) {
        this.auditData.controllableExpense!.variation =
          this.auditData.controllableExpense?.budget_per_plan -
          this.auditData.controllableExpense?.actual_balance;
      }
    }
