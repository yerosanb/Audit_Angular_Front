...
import { RemarkCompiledBranchAuditService } from '../service/remark-compiled-branch-audit.service';
@Component({
  selector: 'app-remark-compiled-branch-audit',
  templateUrl: './remark-compiled-branch-audit.component.html',
  styleUrls: ['./remark-compiled-branch-audit.component.scss'],
})
export class RemarkCompiledBranchAuditComponent {
  ...
  @Input() compiledBranchAudit: CompiledBranchAudit;
  ...
  constructor(
    ...
    private compiledService: RemarkCompiledBranchAuditService,
  ...
  ngOnInit() {
    ...
    this.compiledService.getUserByCategory('BFA').subscribe({
      next: (data) => {
        ...
        this.getUnseenRemarks(this.compiledBranchAudit);
      },
      error: (error: HttpErrorResponse) => {
  ...
  openRemarkDialog(contact: User) {
    this.seenRemark.compiledBranchAudit = this.compiledBranchAudit;
  ...
  sendRemarkEventListener() {
    ...
    this.addRemark.compiledBranchAudit = this.compiledBranchAudit;
