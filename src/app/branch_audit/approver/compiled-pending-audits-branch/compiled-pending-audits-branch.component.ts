...
@Component({
  selector: 'app-compiled-pending-audits-branch',
  templateUrl: './compiled-pending-audits-branch.component.html',
  ...
  styleUrls: ['./compiled-pending-audits-branch.component.scss']
})
export class CompiledPendingAuditsBranchComponent {
  ...
  ngOnInit(): void {
    ...
    this.approverService.getPendingAudits(this.category).subscribe(
      (response) => {
    ...
    this.confirmationService.confirm({
      ...
      accept: () => {
        this.approverService
          .approveAudit(this.selectedAudits)
          .subscribe({
            next: (response) => {
              ...
              this.messageService.add({
                severity: 'success',
                summary: 'Successful',
                detail: 'Selected Audits Approved',
                life: 3000,
              });
            },
            error: (error: HttpErrorResponse) => {
              ...
              this.messageService.add({
                ...
                summary:
                  error.status == 401
                    ? 'You are not permitted to perform this action!'
                    : 'Something went wrong while approving selected findings!',
                detail: '',
              });
            },
          });
            ...
            error: (error: HttpErrorResponse) => {
              ...
              this.messageService.add({
                ...
                summary:
                  error.status == 401
                    ? 'You are not permitted to perform this action!'
                    : 'Something went wrong while approving selected finding!',
                detail: '',
              });
            },
          });
  ...
  addToDraftingSelected() {
    this.approver.id = this.storageService.getUser().id;
    this.selectedAudits[0].approver = this.approver;
    this.confirmationService.confirm({
      message: 'Are you sure you want to edit selected compiled audits ?',
      header: 'Confirm',
      icon: 'pi pi-exclamation-triangle',
      accept: () => {
        this.approverService
          .addToDrafting(this.selectedAudits)
          .subscribe({
            next: (response) => {
              this.compiledRegionalAudits = this.compiledRegionalAudits.filter(
                (val) => !this.selectedAudits.includes(val)
              ...
              this.messageService.add({
                severity: 'success',
                summary: 'Successful',
                detail: 'Audits added to drafting mode',
                life: 3000,
              });
            },
            error: (error: HttpErrorResponse) => {
              ...
              this.messageService.add({
                ...
                summary:
                  error.status == 401
                    ? 'You are not permitted to perform this action!'
                    : 'Something went wrong while adding selected findings to drafting mode!',
                detail: '',
              });
            },
          });
  ...
  addToDrafting(audit:CompiledRegionalAudit) {
    ...
    this.passAudits.push(this.compiledRegionalAudit);
    this.confirmationService.confirm({
      message: 'Are you sure you want to edit the given audit ?',
      header: 'Confirm',
      icon: 'pi pi-exclamation-triangle',
      accept: () => {
        this.approverService
          .addToDrafting(this.passAudits)
          .subscribe({
            next: (response) => {
              this.compiledRegionalAudits = this.compiledRegionalAudits.filter(
                (val) => val.id !== audit.id
              ...
              this.messageService.add({
                severity: 'success',
                summary: 'Successful',
                detail: 'Audit added to drafting mode',
                life: 3000,
              });
            },
            error: (error: HttpErrorResponse) => {
              ...
              this.messageService.add({
                ...
                summary:
                  error.status == 401
                    ? 'You are not permitted to perform this action!'
                    : 'Something went wrong while adding selected finding to drafting mode!',
                detail: '',
              });
            },
          });
  ...
  exportExcel() {
    import('xlsx').then((xlsx) => {
      ...
      this.saveAsExcelFile(excelBuffer, 'Compiled Audits');
    });
  }
