...
@Component({
  selector: 'app-general-observation-reviewer-rectification-tracker',
  templateUrl: './general-observation-reviewer-rectification-tracker.component.html',
  styles: [
    `
  ...
  styleUrls: ['./general-observation-reviewer-rectification-tracker.component.css']
})
export class GeneralObservationReviewerRectificationTrackerComponent {  environment = environment;
  ...
  ngOnInit(): void {
    ...
    this.audit_info.audit_type = 'GeneralObservation';
