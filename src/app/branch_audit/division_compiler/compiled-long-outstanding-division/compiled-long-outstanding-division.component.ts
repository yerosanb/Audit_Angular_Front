...
@Component({
  selector: 'app-compiled-long-outstanding-division',
  templateUrl: './compiled-long-outstanding-division.component.html',
  styleUrls: ['./compiled-long-outstanding-division.component.css']
})
export class CompiledLongOutstandingDivisionComponent {
