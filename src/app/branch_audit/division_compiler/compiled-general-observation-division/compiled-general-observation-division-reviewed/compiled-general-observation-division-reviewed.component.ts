...
@Component({
  selector: 'app-compiled-general-observation-division-reviewed',
  templateUrl: './compiled-general-observation-division-reviewed.component.html',
  styleUrls: ['./compiled-general-observation-division-reviewed.component.css']
})
export class CompiledGeneralObservationDivisionReviewedComponent {
  ...
  ngOnInit(): void {
    ...
    this.parameters.push("GeneralObservation");
