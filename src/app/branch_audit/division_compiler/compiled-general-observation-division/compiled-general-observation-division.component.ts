...
@Component({
  selector: 'app-compiled-general-observation-division',
  templateUrl: './compiled-general-observation-division.component.html',
  styleUrls: ['./compiled-general-observation-division.component.css']
})
export class CompiledGeneralObservationDivisionComponent {
