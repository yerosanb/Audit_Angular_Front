...
@Component({
  selector: 'app-compiled-asset-liability-reviewed-division',
  templateUrl: './compiled-asset-liability-reviewed-division.component.html',
  styleUrls: ['./compiled-asset-liability-reviewed-division.component.css']
})
export class CompiledAssetLiabilityReviewedDivisionComponent {
  ...
  compileAudits() {
    ...
    this.outputData.push('AssetLiability');
