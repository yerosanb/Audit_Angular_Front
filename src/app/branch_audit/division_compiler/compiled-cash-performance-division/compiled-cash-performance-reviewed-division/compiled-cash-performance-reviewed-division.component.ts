...
@Component({
  selector: 'app-compiled-cash-performance-reviewed-division',
  templateUrl: './compiled-cash-performance-reviewed-division.component.html',
  styleUrls: ['./compiled-cash-performance-reviewed-division.component.css'],
})
export class CompiledCashPerformanceReviewedDivisionComponent {
  ...
  ngOnInit(): void {
    ...
    this.parameters.push('CashPerformance');
