...
@Component({
  selector: 'app-compiled-cash-performance-division',
  templateUrl: './compiled-cash-performance-division.component.html',
  styleUrls: ['./compiled-cash-performance-division.component.css']
})
export class CompiledCashPerformanceDivisionComponent {
