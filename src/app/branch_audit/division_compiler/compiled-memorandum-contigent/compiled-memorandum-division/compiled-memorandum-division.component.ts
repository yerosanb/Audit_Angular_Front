...
@Component({
  selector: 'app-compiled-memorandum-division',
  templateUrl: './compiled-memorandum-division.component.html',
  styleUrls: ['./compiled-memorandum-division.component.css']
})
export class CompiledMemorandumDivisionComponent {
