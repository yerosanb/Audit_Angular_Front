...
@Component({
  selector: 'app-compiled-memorandum-reviewed-division',
  templateUrl: './compiled-memorandum-reviewed-division.component.html',
  styleUrls: ['./compiled-memorandum-reviewed-division.component.css']
})
export class CompiledMemorandumReviewedDivisionComponent {
...
total_liability_amount_fcy = 0;
  ...
  ngOnInit(): void {
    ...
    this.parameters.push('Contigent');
