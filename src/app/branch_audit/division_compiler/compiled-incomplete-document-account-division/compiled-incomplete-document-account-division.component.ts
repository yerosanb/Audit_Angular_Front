...
@Component({
  selector: 'app-compiled-incomplete-document-account-division',
  templateUrl: './compiled-incomplete-document-account-division.component.html',
  styleUrls: ['./compiled-incomplete-document-account-division.component.css']
})
export class CompiledIncompleteDocumentAccountDivisionComponent {
