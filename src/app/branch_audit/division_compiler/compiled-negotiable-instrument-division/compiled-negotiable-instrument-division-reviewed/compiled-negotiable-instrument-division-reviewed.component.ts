...
@Component({
  selector: 'app-compiled-negotiable-instrument-division-reviewed',
  templateUrl: './compiled-negotiable-instrument-division-reviewed.component.html',
  styleUrls: ['./compiled-negotiable-instrument-division-reviewed.component.css']
})
export class CompiledNegotiableInstrumentDivisionReviewedComponent {
