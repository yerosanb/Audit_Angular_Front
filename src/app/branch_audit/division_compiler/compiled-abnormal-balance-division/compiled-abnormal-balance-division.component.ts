...
@Component({
  selector: 'app-compiled-abnormal-balance-division',
  templateUrl: './compiled-abnormal-balance-division.component.html',
  styleUrls: ['./compiled-abnormal-balance-division.component.css']
})
export class CompiledAbnormalBalanceDivisionComponent {
