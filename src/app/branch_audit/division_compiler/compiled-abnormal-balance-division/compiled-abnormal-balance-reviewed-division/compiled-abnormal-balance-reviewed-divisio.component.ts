...
@Component({
  selector: 'app-compiled-abnormal-balance-reviewed-divisio',
  templateUrl: './compiled-abnormal-balance-reviewed-divisio.component.html',
  styleUrls: ['./compiled-abnormal-balance-reviewed-divisio.component.css']
})
export class CompiledAbnormalBalanceReviewedDivisioComponent {
  ...
  ngOnInit(): void {
    ...
    this.parameters.push("AbnormalBalance");
