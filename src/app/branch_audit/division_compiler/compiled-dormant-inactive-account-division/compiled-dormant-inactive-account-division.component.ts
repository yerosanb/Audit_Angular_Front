...
@Component({
  selector: 'app-compiled-dormant-inactive-account-division',
  templateUrl: './compiled-dormant-inactive-account-division.component.html',
  styleUrls: ['./compiled-dormant-inactive-account-division.component.css'],
})
export class CompiledDormantInactiveAccountDivisionComponent {
