...
@Component({
  selector: 'app-compiled-dormant-inactive-account-reviewed-division',
  templateUrl: './compiled-dormant-inactive-account-reviewed-division.component.html',
  styleUrls: ['./compiled-dormant-inactive-account-reviewed-division.component.css']
})
export class CompiledDormantInactiveAccountReviewedDivisionComponent {
