...
@Component({
  selector: 'app-compiled-suspense-account-division-pending',
  templateUrl: './compiled-suspense-account-division-pending.component.html',
  styleUrls: ['./compiled-suspense-account-division-pending.component.css'],
})
export class CompiledSuspenseAccountDivisionPendingComponent {
