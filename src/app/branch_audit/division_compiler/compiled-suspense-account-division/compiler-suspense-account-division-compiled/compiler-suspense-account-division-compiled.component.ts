...
@Component({
  selector: 'app-compiler-suspense-account-division-compiled',
  templateUrl: './compiler-suspense-account-division-compiled.component.html',
  styleUrls: ['./compiler-suspense-account-division-compiled.component.css']
})
export class CompilerSuspenseAccountDivisionCompiledComponent {
  ...
  ngOnInit(): void {
    ...
    this.parameters.push("SuspenseAccount");
