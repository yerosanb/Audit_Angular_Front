...
@Component({
  selector: 'app-cashcountdivisionreviewed',
  templateUrl: './cashcountdivisionreviewed.component.html',
  styleUrls: ['./cashcountdivisionreviewed.component.css']
})
export class CashcountdivisionreviewedComponent {
