...
@Component({
  selector: 'app-compiled-cash-count-division',
  templateUrl: './compiled-cash-count-division.component.html',
  styleUrls: ['./compiled-cash-count-division.component.css'],
})
export class CompiledCashCountDivisionComponent {
  ...
  ngOnInit(): void {
    ...
    this.parameters.push('CashCount');
