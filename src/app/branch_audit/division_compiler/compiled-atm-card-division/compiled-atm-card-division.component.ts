...
@Component({
  selector: 'app-compiled-atm-card-division',
  templateUrl: './compiled-atm-card-division.component.html',
  styleUrls: ['./compiled-atm-card-division.component.css']
})
export class CompiledAtmCardDivisionComponent {
