...
@Component({
  selector: 'app-compiled-atm-card-reviewed-division',
  templateUrl: './compiled-atm-card-reviewed-division.component.html',
  styleUrls: ['./compiled-atm-card-reviewed-division.component.css']
})
export class CompiledAtmCardReviewedDivisionComponent {
