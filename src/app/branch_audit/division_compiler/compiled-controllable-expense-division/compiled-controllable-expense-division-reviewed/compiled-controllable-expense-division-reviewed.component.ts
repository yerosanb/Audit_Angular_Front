...
@Component({
  selector: 'app-compiled-controllable-expense-division-reviewed',
  templateUrl:
    './compiled-controllable-expense-division-reviewed.component.html',
  styleUrls: [
    './compiled-controllable-expense-division-reviewed.component.css',
  ],
})
export class CompiledControllableExpenseDivisionReviewedComponent {
  ...
  ngOnInit(): void {
    ...
    this.parameters.push('ControllableExpense');
