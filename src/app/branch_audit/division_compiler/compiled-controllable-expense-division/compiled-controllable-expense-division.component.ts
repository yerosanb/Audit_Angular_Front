...
@Component({
  selector: 'app-compiled-controllable-expense-division',
  templateUrl: './compiled-controllable-expense-division.component.html',
  styleUrls: ['./compiled-controllable-expense-division.component.css']
})
export class CompiledControllableExpenseDivisionComponent {
