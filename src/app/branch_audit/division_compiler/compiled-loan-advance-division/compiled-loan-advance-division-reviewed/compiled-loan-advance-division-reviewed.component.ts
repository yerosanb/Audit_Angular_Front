...
@Component({
  selector: 'app-compiled-loan-advance-division-reviewed',
  templateUrl: './compiled-loan-advance-division-reviewed.component.html',
  styleUrls: ['./compiled-loan-advance-division-reviewed.component.css']
})
export class CompiledLoanAdvanceDivisionReviewedComponent {
