...
@Component({
  selector: 'app-operational-discrepancy-pending-division',
  templateUrl: './operational-discrepancy-pending-division.component.html',
  styleUrls: ['./operational-discrepancy-pending-division.component.css']
})
export class OperationalDiscrepancyPendingDivisionComponent {
