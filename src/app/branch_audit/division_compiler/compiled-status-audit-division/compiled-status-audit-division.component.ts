...
@Component({
  selector: 'app-compiled-status-audit-division',
  templateUrl: './compiled-status-audit-division.component.html',
  styleUrls: ['./compiled-status-audit-division.component.css']
})
export class CompiledStatusAuditDivisionComponent {
