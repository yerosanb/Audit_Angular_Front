...
@Component({
  selector: 'app-compiled-status-audit-division-reviewed',
  templateUrl: './compiled-status-audit-division-reviewed.component.html',
  styleUrls: ['./compiled-status-audit-division-reviewed.component.css']
})
export class CompiledStatusAuditDivisionReviewedComponent {
  ...
  ngOnInit(): void {
    ...
    this.parameters.push("StatusOfAudit");
