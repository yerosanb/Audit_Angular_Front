...
import { AssetLiabilityBranchManagerService } from '../service/asset-liability-branch-manager.service';



  @Component({
    selector: 'app-asset-liability-pending-branch-manager',
    templateUrl: './asset-liability-pending-branch-manager.component.html',
    styles: [
      `
    ...
    styleUrls: ['./asset-liability-pending-branch-manager.component.css']
  })
  export class AssetLiabilityPendingBranchManagerComponent {
...
descripancyCategory: OperationalDescripancyCategory = new  OperationalDescripancyCategory()
  ...
  constructor(
    ...
    private assetLiabilityBranchManagerService: AssetLiabilityBranchManagerService,
  ...
  getFindings(branch_audit: any) {
    this.assetLiabilityBranchManagerService.getPendingAudits(branch_audit).subscribe(
      (response) => {
