...
import { AssetLiabilityReviewerBranchService } from '../service/asset-liability-reviewer-branch.service';
...
@Component({
  selector: 'app-asset-liability-pending-for-review-branch',
  templateUrl: './asset-liability-pending-for-review-branch.component.html',
  styles: [
    `
  ...
  styleUrls: ['./asset-liability-pending-for-review-branch.component.css'],
})
export class AssetLiabilityPendingForReviewBranchComponent {
  ...
  constructor(
    ...
    private assetLiabilityReviewerBranchService: AssetLiabilityReviewerBranchService,
  ...
  getFindings(category: any) {
    this.assetLiabilityReviewerBranchService
      .getPendingAssetLiablity(category)
      .subscribe(
        (response) => {
  ...
  reviewAssetLiability(audit: BranchFinancialAudit) {
