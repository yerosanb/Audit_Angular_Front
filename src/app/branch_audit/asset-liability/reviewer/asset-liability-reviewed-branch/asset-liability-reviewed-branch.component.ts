...
import { AssetLiabilityAuditorBranchService } from '../../auditor/service/asset-liability-auditor-branch.service';
import { AssetLiabilityReviewerBranchService } from '../service/asset-liability-reviewer-branch.service';

@Component({
  selector: 'app-asset-liability-reviewed-branch',
  templateUrl: './asset-liability-reviewed-branch.component.html',
  styles: [
    `
  ...
  styleUrls: ['./asset-liability-reviewed-branch.component.scss'],
})
export class AssetLiabilityReviewedBranchComponent {
  ...
  constructor(
    ...
    private assetLiabilitryAuditorService: AssetLiabilityAuditorBranchService,
    private regionService: RegionService,
    private commonReviewService: CommonReviewerBranchFinancialService,
  ...
  cancelReviewedAssetLiability(audit: BranchFinancialAudit) {
    this.confirmationService.confirm({
      message: 'Are you sure you want to unReview ' + audit.case_number + '?',
      header: 'Confirm',
      icon: 'pi pi-exclamation-triangle',
      accept: () => {
        this.commonReviewService.unReviewAuditFindings(audit).subscribe({
          next: (response) => {
