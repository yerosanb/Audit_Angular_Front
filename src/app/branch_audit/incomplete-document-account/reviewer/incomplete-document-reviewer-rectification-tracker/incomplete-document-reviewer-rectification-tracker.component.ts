...
@Component({
  selector: 'app-incomplete-document-reviewer-rectification-tracker',
  templateUrl:
    './incomplete-document-reviewer-rectification-tracker.component.html',
  styles: [
    `
  ...
  styleUrls: [
    './incomplete-document-reviewer-rectification-tracker.component.css',
  ],
})
export class IncompleteDocumentReviewerRectificationTrackerComponent {
  ...
  ngOnInit(): void {
    ...
    this.audit_info.audit_type = 'IncompleteAccount';
