...
@Component({
  selector: 'app-incomplete-account-drafting-branch',
  templateUrl: './incomplete-account-drafting-branch.component.html',
  styles: [
    `
  ...
  styleUrls: ['./incomplete-account-drafting-branch.component.css'],
})
export class IncompleteAccountDraftingBranchComponent {
  ...
  getFindings(auditor_id: number) {
    this.auditService.getAuditsOnDrafting(auditor_id).subscribe(
      (response) => {
