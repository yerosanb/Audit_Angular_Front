...
@Component({
  selector: 'app-incomplete-document-account-create-edit',
  templateUrl: './incomplete-document-account-create-edit.component.html',
  styleUrls: ['./incomplete-document-account-create-edit.component.css'],
})
export class IncompleteDocumentAccountCreateEditComponent {
  ...
  constructor(
    ...
    private ancompleteAccountAuditorBranchService: IncompleteAccountAuditorBranchService,
  ...
  editAudit(passedData: any[]) {
    ...
    console.log(this.auditData.incompleteAccountBranch);
    ...
    let accountOpenedDate: any;
    accountOpenedDate =
      this.auditData.incompleteAccountBranch?.account_opened_date;
    this.accountOpenedDate = new Date(accountOpenedDate);

    this.account_type_intial =
      this.auditData.incompleteAccountBranch?.account_type;
    ...
    if (this.account_type_intial == 'FCY') {
      this.is_fcy = true;
    }
  ...
  saveAudit() {
    ...
    let accountOpenedDate: any;
    accountOpenedDate = this.accountOpenedDate;
    if (this.auditData.incompleteAccountBranch)
      this.auditData.incompleteAccountBranch.account_opened_date =
        accountOpenedDate;
    ...
    this.auditData.audit_type = 'IncompleteDocument';
    ...
    if (this.file_uploaded) {
      this.loading = true;
      this.ancompleteAccountAuditorBranchService
