...
import { LoanAndAndAdvanceBranchManagerService } from '../service/loan-and-and-advance-branch-manager.service';

  @Component({
    selector: 'app-loan-and-advance-pending-branch-manager',
    templateUrl: './loan-and-advance-pending-branch-manager.component.html',
    styles: [
      `
    ...
    styleUrls: ['./loan-and-advance-pending-branch-manager.component.css']
  })
  export class LoanAndAdvancePendingBranchManagerComponent  {
  ...
  descripancyCategory: OperationalDescripancyCategory = new  OperationalDescripancyCategory()
    ...
    constructor(
      ...
      private loanAndAndAdvanceBranchManagerService: LoanAndAndAdvanceBranchManagerService,
  ...
  private remarkService: RemarkBranchAuditService,
    ...
    getFindings(branch_audit: any) {
      this.loanAndAndAdvanceBranchManagerService.getPendingAudits(branch_audit).subscribe(
        (response) => {
