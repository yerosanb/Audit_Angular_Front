...
@Component({
  selector: 'app-loan-and-advance-reviewer-rectification-tracker',
  templateUrl: './loan-and-advance-reviewer-rectification-tracker.component.html',
  styles: [
    `
  ...
  styleUrls: ['./loan-and-advance-reviewer-rectification-tracker.component.css']
})
export class LoanAndAdvanceReviewerRectificationTrackerComponent {  environment = environment;
  ...
  ngOnInit(): void {
    ...
    this.audit_info.audit_type = 'LoanAdvance';
    ...
    this.cols = [
      ...
      { field: 'due_date', header: 'Repayement Date' },
