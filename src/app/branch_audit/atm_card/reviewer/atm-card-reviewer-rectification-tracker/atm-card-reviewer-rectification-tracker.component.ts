...
@Component({
  ...
  selector: 'app-atm-card-reviewer-rectification-tracker',
  templateUrl: './atm-card-reviewer-rectification-tracker.component.html',
  styles: [
    `
  ...
  styleUrls: ['./atm-card-reviewer-rectification-tracker.component.css'],
})
export class AtmCardReviewerRectificationTrackerComponent {
  ...
  ngOnInit(): void {
    ...
    this.audit_info.audit_type = 'ATMCard';
