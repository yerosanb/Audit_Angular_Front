...
@Component({
  selector: 'app-reviewer-memorandum-passed',
  templateUrl: './reviewer-memorandum-passed.component.html',
  styles: [
    `
  ...
  styleUrls: ['./reviewer-memorandum-passed.component.css']
})
export class ReviewerMemorandumPassedComponent {
  ...
  ngOnInit(): void {
    ...
    this.reviewerMemorandumService.getReviewedFindings(user.id).subscribe(
      (response) => {
  ...
  compileAudits() {
    ...
    this.outputData.push('Contigent');
