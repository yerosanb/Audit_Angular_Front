...
@Component({
  selector: 'app-memorandum-reviewer-rectification-tracker',
  templateUrl: './memorandum-reviewer-rectification-tracker.component.html',
  styleUrls: ['./memorandum-reviewer-rectification-tracker.component.css']
})
export class MemorandumReviewerRectificationTrackerComponent {
  ...
  ngOnInit(): void {
    ...
    this.audit_info.audit_type = 'Contigent';
