...
@Component({
  selector: 'app-memorandum-passed',
  templateUrl: './memorandum-passed.component.html',
  styles: [
    `
  ...
  styleUrls: ['./memorandum-passed.component.css'],
})
export class MemorandumPassedComponent {
  ...
  getFindings(auditor_id: number) {
    this.auditorMemorandumService.getPassedAudit(auditor_id).subscribe(
      (response) => {
