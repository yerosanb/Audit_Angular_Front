...
@Component({
  selector: 'app-memorandom-create-edit',
  templateUrl: './memorandom-create-edit.component.html',
  styleUrls: ['./memorandom-create-edit.component.css'],
})
export class MemorandomCreateEditComponent {
  ...
  getCommonFindings() {
    this.commonFindingService
      .getFindingsByAuditType('MemorandomContingent')
      .subscribe(
        (response) => {
  ...
  getCommonRecommendations() {
    this.recommendationService
      .getRecommondationsByAuditType('MemorandomContingent')
      .subscribe(
        (response) => {
  ...
  editAudit(passedData: any[]) {
    ...
    this.cash_type_intial = this.auditData.abnormalBalanceBranch?.cash_type;
  ...
  saveAudit() {
    ...
    if (this.file_uploaded) {
      this.loading=true;
      this.auditorMemorandumService.create_audits(this.auditData).subscribe({
        next: () => {
  ...
  computeDifference() {
    if (this.auditData.memorandumContigent) {
      if (
        this.auditData.memorandumContigent?.contingent_amount &&
        this.auditData.memorandumContigent?.memorandom_amount
      ) {
        this.auditData.memorandumContigent!.difference =
          this.auditData.memorandumContigent?.memorandom_amount -
          this.auditData.memorandumContigent?.contingent_amount;
      }
    }
