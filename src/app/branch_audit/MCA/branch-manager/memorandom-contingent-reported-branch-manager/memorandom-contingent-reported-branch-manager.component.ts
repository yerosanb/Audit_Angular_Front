...
import { MemorandomContingentBranchManagerService } from '../service/memorandom-contingent-branch-manager.service';



@Component({
  selector: 'app-memorandom-contingent-reported-branch-manager',
  templateUrl: './memorandom-contingent-reported-branch-manager.component.html',
  styleUrls: ['./memorandom-contingent-reported-branch-manager.component.css']
})
export class MemorandomContingentReportedBranchManagerComponent {
...
descripancyCategory: OperationalDescripancyCategory = new  OperationalDescripancyCategory()
  ...
  constructor(
    ...
    private MemorandomcontingentBranchManagerService: MemorandomContingentBranchManagerService,
  ...
  getFindings(branch_audit: any) {
    this.MemorandomcontingentBranchManagerService.getPendingAudits(branch_audit).subscribe(
      (response) => {
