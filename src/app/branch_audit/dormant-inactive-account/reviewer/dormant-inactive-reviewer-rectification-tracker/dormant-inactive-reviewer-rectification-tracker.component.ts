...
@Component({
  selector: 'app-dormant-inactive-reviewer-rectification-tracker',
  templateUrl: './dormant-inactive-reviewer-rectification-tracker.component.html',
  styles: [
    `
  ...
  styleUrls: ['./dormant-inactive-reviewer-rectification-tracker.component.css']
})
export class DormantInactiveReviewerRectificationTrackerComponent {
  ...
  ngOnInit(): void {
    ...
    this.audit_info.audit_type = 'Dormant';
