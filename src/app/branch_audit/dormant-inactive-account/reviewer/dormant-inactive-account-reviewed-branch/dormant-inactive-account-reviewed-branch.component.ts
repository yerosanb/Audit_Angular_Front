...
@Component({
  selector: 'app-dormant-inactive-account-reviewed-branch',
  templateUrl: './dormant-inactive-account-reviewed-branch.component.html',
  styles: [
    `
  ...
  styleUrls: ['./dormant-inactive-account-reviewed-branch.component.css'],
})
export class DormantInactiveAccountReviewedBranchComponent {
