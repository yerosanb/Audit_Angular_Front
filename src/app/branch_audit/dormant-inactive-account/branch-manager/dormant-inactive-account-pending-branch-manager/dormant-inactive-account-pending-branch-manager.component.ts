...
import { DormantInactiveAccountBranchManagerService } from '../service/dormant-inactive-account-branch-manager.service';

  @Component({
    selector: 'app-dormant-inactive-account-pending-branch-manager',
    templateUrl: './dormant-inactive-account-pending-branch-manager.component.html',
    styles: [
      `
    ...
    styleUrls: ['./dormant-inactive-account-pending-branch-manager.component.css']
  })
  export class DormantInactiveAccountPendingBranchManagerComponent  {
  ...
  currentUser = new User();
    ...
    constructor(
      ...
      private dormantInactiveAccountBranchManagerService: DormantInactiveAccountBranchManagerService,
    ...
    ngOnInit() {
     let branch_id= this.storageService.getUser().branch?.id;
      ...
      // this.getUnseenRemarks(this.audit);
      this.cols = [
    ...
    getFindings(branch_audit: any) {
      this.dormantInactiveAccountBranchManagerService.getPendingAudits(branch_audit).subscribe(
        (response) => {
