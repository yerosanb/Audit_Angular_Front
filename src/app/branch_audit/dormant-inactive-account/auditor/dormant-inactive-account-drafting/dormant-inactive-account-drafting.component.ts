...
@Component({
  selector: 'app-dormant-inactive-account-drafting',
  templateUrl: './dormant-inactive-account-drafting.component.html',
  styles: [
    `
  ...
  styleUrls: ['./dormant-inactive-account-drafting.component.css'],
})
export class DormantInactiveAccountDraftingComponent {
  ...
  ngOnInit() {
    ...
    // console.log(this.storageService.getUser().branch.id);
    ...
    this.cols = [
      ...
      { field: 'acount_name', header: 'customer name' },
      ...
      { field: 'deactivated_date', header: 'Date_of_account_Deactivated' },
    ];
